...
/**
 * d3.scaleOrdinal  构造一个默认的序数比例尺，默认的domain和 range都为空. 一般用作颜色序数比例尺。
 * d3.schemeCategory20c  颜色序数比例尺
 * */
...
/**
 * axis.tickSize([size]) 如果指定了 size 则设置 内侧 和 外侧 刻度大小并返回axis. 如果 size 没有指定则返回当前的刻度尺寸,默认为6.
 * axis.tickPadding([padding])  padding为刻度和刻度值之间的间距
